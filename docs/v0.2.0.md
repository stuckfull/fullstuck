...
*   **`fst:loading`**: Dikirim ketika fetch (navigasi / submit form) baru saja dimulai. Membawa informasi detail rute yang dipanggil di dalam properti `e.detail` (`url`, `targetSelector`, `triggerElement`).
