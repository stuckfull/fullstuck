 ...
 * 💡 Version: 0.2.0 | FST_HASH: 9ba5827024587e8d221e208437fa83cdb690d103fa04ea94c2309fca0add51ba
 *
 * 🛑 ===================================================================== 🛑
        ...
        try {
            ...
            if ($server_type === 'apache_litespeed') {
                $htaccess_code = implode("\n", [
                    ...
                    '    RewriteBase /',
                    '    ',
                    '    # 2. Aturan "Rakus" (Kirim SEMUA ke index.php)',
            ...
            if (!file_exists(FST_ROOT_DIR . '/index.php')) {
                $index_code = "<?php\n\n// FullStuck.php Entry Point\n// Automatically generated by the installer.\n\nrequire_once __DIR__ . '/fullstuck.php';\n";
                @file_put_contents(FST_ROOT_DIR . '/index.php', $index_code);
            }
